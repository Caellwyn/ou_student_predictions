...
2. I could try larger prediction window and focus more on failing students than withdrawing ones, or a smaller prediction window to provide earlier interventions and prevent more withdrawals.
